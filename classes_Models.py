...
class ResearchModels():
    def __init__(self, model = 'cnn', seq_length = 0, image_size = [32,22],
                 num_ch = 1, num_output = 2, optimizer = 'Adagrad',
...
#        optimizer = Adam(lr=1e-5, decay=1e-6)
    ...
    def cnn(self):
        ...
        _ = Conv2D(64,(3,3), activation = 'relu', padding = 'same',
                   kernel_initializer= self.kernel_init_cnn)(_)
        _ = MaxPooling2D((2,2), padding = 'same')(_)
        _ = Conv2D(128, (3,3), activation = 'relu', padding = 'same',
                   kernel_initializer= self.kernel_init_cnn)(_)
        _ = MaxPooling2D((2,2), padding = 'same')(_)
    ...
    def lrcn(self):
        ...
        last_common_layer = LSTM(units = 32, activation='tanh', return_sequences=True, 
                                 kernel_initializer= self.kernel_init_lstm, dropout = 0.5, name = 'LSTM')(_)
        if self.num_output == 2:
            #------ FP 1 output'''   
